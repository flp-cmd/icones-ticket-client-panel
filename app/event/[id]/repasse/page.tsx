            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-blue-800">
                  <li>
                    O repasse é calculado sobre o faturamento das taxas de
                    vendas
                  </li>
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className={`w-full md:w-auto px-4 py-2 bg-[#0A484D] text-white font-medium rounded-lg hover:bg-[#083a3e] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0A484D] transition-colors ${
